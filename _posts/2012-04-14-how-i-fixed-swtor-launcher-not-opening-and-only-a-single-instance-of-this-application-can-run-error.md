...
[<img class="aligncenter size-full wp-image-20" alt="SWTOR" title="only-single-instance" src="/images/posts/2012/04/only-single-instance.png" width="312" height="144" />][1]
...
[<img class="aligncenter size-full wp-image-12" alt="SWTOR" title="task-manager" src="/images/posts/2012/04/task-manager.png" width="810" height="612" />][3]
...
[<img class="aligncenter size-full wp-image-17" alt="SWTOR" title="fix-launcher-failed-need-to-close-launcher-process" src="/images/posts/2012/04/fix-launcher-failed-need-to-close-launcher-process.png" width="527" height="392" />][4]
...
[<img class="aligncenter size-full wp-image-13" alt="SWTOR" title="delete-patch-folder" src="/images/posts/2012/04/delete-patch-folder.png" width="798" height="640" />][5]

&nbsp;

Ran FixLauncher.exe again:

[<img class="aligncenter size-full wp-image-15" alt="SWTOR" title="fixing" src="/images/posts/2012/04/fixing.png" width="527" height="392" />][6] **
...
** [<img class="aligncenter size-full wp-image-19" alt="SWTOR" title="launcher-updating-after-fix" src="/images/posts/2012/04/launcher-updating-after-fix.png" width="1000" height="632" />][7]
...
[<img class="aligncenter size-full wp-image-14" alt="SWTOR" title="downloading-remaining-patch-files" src="/images/posts/2012/04/downloading-remaining-patch-files.png" width="1000" height="632" />][8]

### <a name='quickfix'></a>TL;DR...
...
6.  The launcher will update itself and then you should be able to login and play as normal.
 ...
 [1]: /images/posts/2012/04/only-single-instance.png
 [2]: #quickfix
 [3]: /images/posts/2012/04/task-manager.png
 [4]: /images/posts/2012/04/fix-launcher-failed-need-to-close-launcher-process.png
 [5]: /images/posts/2012/04/delete-patch-folder.png
 [6]: /images/posts/2012/04/fixing.png
 [7]: /images/posts/2012/04/launcher-updating-after-fix.png
 [8]: /images/posts/2012/04/downloading-remaining-patch-files.png
